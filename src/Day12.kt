class Day12 {
    ...
    private fun createField(): Triple<MutableMap<Pair<Int, Int>, Point>, Pair<Int, Int>, Pair<Int, Int>> {
        val field = mutableMapOf<Pair<Int, Int>, Point>()
            ...
            line.toCharArray().forEachIndexed { x, char ->
                when (char) {
                    ...
                    'E' -> {
                        ...
                        field[Pair(x, y)] = Point(coordinates = Pair(x, y), height = char)
                    }
                }
            }
        }
    ...
    private fun findShortestPath(
        ...
        allPoints: MutableMap<Pair<Int, Int>, Point>,
        end: Pair<Int, Int>
    ): Int {
        var moves = 0
